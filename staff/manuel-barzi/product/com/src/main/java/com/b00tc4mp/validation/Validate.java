...
public class Validate {
    ...
    public static void name(String name) throws ValidationException {
        if (name == null) throw new ValidationException("name is null");
    ...
    public static void username(String username) throws ValidationException {
        if (username == null) throw new ValidationException("username is null");
        if (username.isEmpty()) throw new ValidationException("username is empty");
    }

    public static void password(String password) throws ValidationException {
        if (password == null) throw new ValidationException("password is null");
        if (password.isEmpty()) throw new ValidationException("password is empty");
    }

    public static void passwords(String password, String passwordRepeat) throws ValidationException {
        Validate.password(password);

        if (passwordRepeat == null) throw new ValidationException("passwordRepeat is null");
        if (passwordRepeat.isEmpty()) throw new ValidationException("passwordRepeat is empty");
    ...
    public static void userId(String userId) throws ValidationException {
        ...
        if (userId.isEmpty()) throw new ValidationException("userId is empty");
    }
}
